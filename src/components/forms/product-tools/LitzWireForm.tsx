...
export function LitzWireForm({
	...
	const form = useForm<LitzWireFormValues>({
		resolver: zodResolver(litzWireFormSchema),
		defaultValues: {
	...
	const handleNumberOfStrandsChange = (value: string) => {
		...
		if (currentStrandSize && typeof currentStrandSize === "string") {
