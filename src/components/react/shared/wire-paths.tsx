...
interface WirePathsProps extends SVGProps<SVGSVGElement> {
	...
	ease?: string;
	/**
	 * The aria-label for the SVG element
	 * @default "Decorative wire animation"
	 */
	"aria-label"?: string;
}
...
export function WirePaths({
	...
	repeat = 0,
	ease = "easeInOut",
	"aria-label": ariaLabel = "Decorative wire animation",
	...props
}: WirePathsProps) {
	return (
		<svg
		...
		>
			<defs>
				<linearGradient id="wireGradient1" x1="0" y1="0" x2="1" y2="0">
					<stop
						offset="0%"
				...
				<linearGradient id="wireGradient2" x1="0" y1="0" x2="1" y2="0">
					<stop
						offset="0%"
						className="stop-primary"
						style={{ stopColor: "hsl(var(--primary))", stopOpacity: 0.8 }}
					...
					<stop
						offset="100%"
						className="stop-primary"
						style={{ stopColor: "hsl(var(--primary))", stopOpacity: 0.6 }}
					/>
				</linearGradient>
				<linearGradient id="wireGradient3" x1="0" y1="0" x2="1" y2="0">
					<stop
						offset="0%"
						className="stop-primary"
						style={{ stopColor: "hsl(var(--primary))", stopOpacity: 0.6 }}
					...
					<stop
						offset="100%"
						className="stop-primary"
						style={{ stopColor: "hsl(var(--primary))", stopOpacity: 0.4 }}
					/>
				</linearGradient>
				<linearGradient id="wireGradient4" x1="0" y1="0" x2="1" y2="0">
					<stop
						offset="0%"
						className="stop-primary"
						style={{ stopColor: "hsl(var(--primary))", stopOpacity: 0.4 }}
				...
				<linearGradient id="wireGradient5" x1="0" y1="0" x2="1" y2="0">
					<stop
						offset="0%"
						className="stop-primary"
						style={{ stopColor: "hsl(var(--primary))", stopOpacity: 0.2 }}
